...
class Simulation:
  ...
  def __InputCoordinate(self, CoordinateName):
    ...
    #
    # while not(Coordinate >= 0 and Coordinate < self.__LandscapeSize):
    #   print('Coordinate is outside of landscape, please try again.')
    #   Coordinate = int(input("  Input " + CoordinateName + " coordinate:"))

    # Method 2
    while True:
      Coordinate = int(input("  Input " + CoordinateName + " coordinate:"))
      if Coordinate < 0 or Coordinate >= self.__LandscapeSize:
        print('Coordinate is outside of landscape, please try again.')
      else:
        break
    ...
    # if Coordinate < 0 or Coordinate >= self.__LandscapeSize:
    #   print('Coordinate is outside of landscape, please try again.')
    #   return self.__InputCoordinate(CoordinateName)
...
class Rabbit(Animal):
  ...
  def CalculateNewAge(self):
    ...
    if self.IsFemale():
      if self._Age >= 2:
        self._ProbabilityOfDeathOtherCauses = self._ProbabilityOfDeathOtherCauses + 0.05
    else:
      self._ProbabilityOfDeathOtherCauses = self._ProbabilityOfDeathOtherCauses * 1.5
